        ...
        <div class="container">
            <form class="form-horizontal" method="post" action="../controllers/editController.php">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control" id="description" name="description" placeholder="Description" value="<?php echo $creature->getdecription(); ?>">
                    </div>
                </div>
                <div class="form-group">
                 ...
                 <div class="form-group">
                    <label for="avatar" class="col-sm-2 control-label">AttackPower</label>
                    <div class="col-sm-10">
                 ...
                 <div class="form-group">
                    <label for="avatar" class="col-sm-2 control-label">LifeLevel</label>
                    <div class="col-sm-10">
                 ...
                 <div class="form-group">
                    <label for="avatar" class="col-sm-2 control-label">Weapon</label>
                    <div class="col-sm-10">
